...
export default {
  ...
  beforeMount() {
    ...
    // this.searchParmas.category2Id = this.$route.query.category2Id
    // this.searchParmas.category3Id = this.$route.query.category3Id
    // this.searchParmas.categoryName = this.$route.query.categoryName
    // this.searchParmas.keyword = this.$route.params.keyword
    // 使用ES6语法，Object.assign()赋值
